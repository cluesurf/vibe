...
export const PENTAGRID_RULES: string[] = [
  'WWWWWWW', 'WBWWWWW', 'WGWWWWW', 'WWWWBGW', 'WWWWGBW', 'WWWWBBW', 'WGGWWWW', 'WRGWWWW', 'BWWWWWB', 'GWWWWWG', 'BWWWWBB', 'BWWWWGB',
  'GWWWWGG', 'BWWWBBB', 'BWWWBGB', 'BWWWGBB', 'BBBWBWB', 'BBBWWBB', 'BWWBWBB', 'BWWBGBB', 'BBBWBGB', 'BBGWWBB', 'BBWGWBB', 'BBWWGBB',
  'BBBWBRB', 'BBBGWBB', 'BBBRWBB', 'BBRWWBB', 'BBWRWBB', 'BBWWRBB', 'WWWBWBW', 'WWWBWGW', 'WWWGWBW', 'WWGBWBG', 'WWGBWGG', 'WGWBWBG',
  'WGWBWGW', 'WGWGWBG', 'WRWBWBR', 'WWRBWBR', 'WWRBWGR', 'WRWGWBR', 'WWWBGBW', 'WWWBGGW', 'WWWBRBW', 'GWWBWBW', 'GWWBWGW', 'GWWGWBW',
  'RWWBWBW', 'RWWBWGW', 'RWWGWBW', 'WWWWWRW', 'WWWWRRW', 'WWWWRBW', 'WWBWRRW', 'RWWWWRR', 'BWWWWRB', 'WWWWBRW', 'RWWWWBR', 'RWWWWWR',
  'WWWRWBW', 'RGBWWWR', 'BGRWWWB', 'BRRWWWB', 'BGWWWRB', 'WGWRWBW', 'BRWBWWB', 'BRBWWWB', 'RBRWWWR', 'RRBWWWR', 'WWBBGWG', 'WGBWRRR',
  'GWBBWWW', 'WGBBWWW', 'WRBBWWW', 'RWBWRRW', 'BRWWWBB', 'RGWWWWR', 'WWBBRWR', 'RWBBWWW', 'WRBWRRW', 'WRWRWBG', 'WWBBWGW', 'GWWRWBW',
  'BGWBWWB', 'BBRBWWB', 'GWYGGWG', 'YGGBBBY', 'GGBWWWG', 'GGWWWRG', 'BGYWWWB', 'WWGRRRW', 'GWRWWWG', 'WWBWGRW', 'GWRGGYG', 'RGWRRRR',
  'GGRWWWG', 'GGWWWBG', 'RRGWWWR', 'RGRWWWR', 'WGWGWGG', 'BWGBWBB', 'GGWWWGW', 'GGYGGWG', 'WGBWGRW', 'GGRGGYG', 'WGGWWGW', 'WGGRRRG',
  'GWYGGGW', 'WWGGGBW', 'GWGRRRG', 'RGGWWWR', 'WWYGGGW', 'YWGBBBR', 'GWBWWWG', 'GWWRRRG', 'WWRGGGB', 'RWGBBBY', 'GWRGGRW', 'BWYGGGG',
  'YBWBBBY', 'GBWWWRG', 'GWBRRRR', 'WWRGGYG', 'RWWRRRW', 'GWYGGRG', 'WWRGWBW', 'RWGRRRR', 'GWWGGYG', 'WGWRRRW', 'GGYGGRG', 'WGRGWBW',
  'GGWGGYG', 'BGWBWBB', 'WWBGGGW', 'GWGGGYW', 'GGWRRRG', 'YGWBBBR', 'WWGGGYW', 'RGWBBBY', 'WWGGGRB', 'WWYGGRG', 'BWGGGYG', 'GBWRRRR',
  'GWBGGWG', 'GWRGGBG', 'WWGGWBW', 'WWWGGBW', 'BGGBWBB', 'BBGWWGB', 'WBGWWGW', 'WWGRBRW', 'RGWRBRR', 'GGBGGWG', 'GGRGGBG', 'WGGRBRW',
  'GWBGGRG', 'RWGRBRR', 'GWWGGBG', 'WGWRBRW', 'GGBGGRG', 'GGWGGBG', 'BGGBGBR', 'GBGWWGW', 'GWRGGWR', 'RGGBWBB', 'BRGWWGB', 'WRGWWGW',
  'RWBGGWG', 'BRWBWBB', 'GRWWWRG', 'WWRRBRR', 'WWRGGBG', 'RWWRBRW', 'GWWGGRR', 'WWBGGRG', 'BWRBWBB', 'RWWGGBG', 'WRWRBRR', 'GRWWWBG',
  'BBWWYYB', 'BBYYBWB', 'YBYBWWY', 'YBWWWWY', 'BYWWWWB', 'WYWWWWW', 'WYYWWWW', 'WBYWWWW', 'YBWBYYY', 'WYWBWWW', 'BYWBWWB', 'YYWWWWY',
  'WYBWWWW', 'YBYRWYY', 'YYYWWWY', 'RYWWWWR', 'WYWBWBW', 'WRYWWWW', 'BBYYBGB', 'BBGWYYB', 'BGGWWWB', 'WYWBWGG', 'BYGBWWB', 'YBGBYYY',
  'GYWBWWW', 'BBWGYYR', 'WYGBWWW', 'RBWWYYB', 'BRYYBWY', 'WRWWGGW', 'WRGBWWW', 'YRWBYYB', 'YRYRWYG', 'BYWWBGB', 'YYGBWWY', 'BYWWBWB',
  'WWYWWBW', 'GBYRWYY', 'YGBWWWY', 'BYWWBYB', 'YYYBWWY', 'BYGWWWB', 'YBYRGYY', 'YYBWWWY', 'GYWBWBW', 'WGRWWWW', 'BYWGBYB', 'WWYGWBG',
  'GWYWWBW', 'BYGWBYR', 'WGYWWBW', 'RYWWBYB', 'YRYYBWB', 'BRWBYYY', 'YBGBWWY', 'YGYWWWY',
]
...
export function buildPentagridRuleTable(rules: string[] = PENTAGRID_RULES): PentagridRuleTable {
  ...
  for (const rule of rules) {
    ...
    for (let r = 0; r < 5; r++) {
      ...
      if (existing !== undefined && existing !== next) {
        throw new Error(`rule conflict at ${key}: ${existing} vs ${next} (rule ${rule})`)
      }
      lookup.set(key, next)
    }
  }
...
export function pentagridNext(table: PentagridRuleTable, current: PentaState, neighbours: PentaState[]): PentaState {
