// The glide weave: a pair rule that keeps a colour triality only together with a shift in time.
//
// E-FRC-0112 shows that a rule carried to itself by a colour triality sigma on every beat can move
// tones between a colour line and its orbit only in threes, which is why the triality weave needs a
...
// perfect matching of the 12 lines. The matchings, with colour lines c_i and orbit lines o_(i,j),
...
// each colour line meets every line of two orbits one at a time, which no rule symmetric beat by beat
