...
function componentExponents(
  ...
  if (size === 3) {
    ...
    if (key === '3,3') return [1, 2, 3]
    // A3

    if (key === '4,3' || key === '3,4') return [1, 3, 5]
    // B3

    if (key === '5,3' || key === '3,5') return [1, 5, 9]
    // H3
  ...
  if (size === 4) {
    ...
    if (key === '3,3,3') return [1, 2, 3, 4]
    // A4

    if (key === '4,3,3' || key === '3,3,4') return [1, 3, 5, 7]
    // B4

    if (key === '3,4,3') return [1, 5, 7, 11]
    // F4

    if (key === '5,3,3' || key === '3,3,5') return [1, 11, 19, 29]
    // H4
