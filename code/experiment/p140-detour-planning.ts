...
//
// HONEST SCOPE. This tests the LOGIC of planning, that lookahead beats greedy on a barrier, NOT that
// planning emerges from the five base things. What is from the base, the value landscape IS the arrow (a
// value-direction toward a goal), and the greedy agent IS the gap-closing rule. What is ADDED, an EXPLICIT
// K-step lookahead/search algorithm, coded here, not derived from the mesh dynamics. So this shows IF the
// substrate has lookahead it can plan, it does not show the lookahead comes from the base. A from-the-base
// version (P142) must build the lookahead from the EMERGENT forward model (P118) and will (P113), adding
// nothing new. See computable-to-intentional.md and verifying-planning-could-evolve.md.
//
