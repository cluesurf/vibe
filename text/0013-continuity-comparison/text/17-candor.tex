...
The map from the lattice sum rule to a specific field with a stress tensor that sources curvature is unbuilt.
...
leaves the rest, but a parallel to an unconfirmed program is a weaker anchor than a parallel to an established one.
