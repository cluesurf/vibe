...
$\nabla\!\cdot J = 0$, the one law a conserved-current program posits and forces
everything else from \cite{herbert2025chronoflux}.
...
the direction it points and added, one arrow saying which way the charge flows.
