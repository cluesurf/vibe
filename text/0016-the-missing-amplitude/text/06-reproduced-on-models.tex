...
four. The code counted components before anyone had looked for them. The same complex with its boundary maps oriented
over the field of three elements carries the $\mathbb{Z}_3$ toric code, whose alphabet is the tone itself: the
checks commute exactly and the count is again four logical qutrits per torus and zero on a patch. The mesh, then, is a substrate on which
