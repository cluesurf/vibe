...
\subsection{Why the 24-cell is the right cell}

A self-dual, maximally symmetric, spinor-carrying, densest-packing 4D solid whose $24$ directions are the $D_4$ roots is the natural best cell for a selection principle to single out. It is more densely connected than the dodecahedron of $\{5,3,4\}$, with $24$ face-neighbours against $12$, and it carries quaternions and a discrete Hopf fibration, so a $24$-cell substrate arrives with rich built-in spinor geometry. Picture 4D hyperbolic space packed solid with these $24$-cells, meeting face to face, and you have the body of the mesh.
