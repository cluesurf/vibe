...
\subsubsection{The Capitoline Triad}

Above the borrowed pantheon stood three chief gods of the Roman state, worshipped
together in the great temple on the \textbf{Capitoline Hill}. They were the
\textbf{Capitoline Triad}, the center of public religion in Rome.

\begin{longtable}{L{0.22\linewidth} L{0.54\linewidth}}
\caption{The Capitoline Triad, the three chief gods of the Roman state.}\\
\toprule
\textbf{God} & \textbf{Role in the state cult} \\
\midrule
Jupiter & The sky-father and king of gods, chief guardian of Rome \\
Juno & The queen of gods, protector of the state and its women \\
Minerva & The goddess of wisdom, craft, and just war \\
\bottomrule
\end{longtable}

An older grouping, the \textbf{Archaic Triad}, paired \textbf{Jupiter} with
\textbf{Mars}, the god of war, and \textbf{Quirinus}, the deified founder. The
later Capitoline Triad replaced it as the chief cult of the city.
