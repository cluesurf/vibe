...
\subsection{The four Vedas}

The oldest scriptures are the four Vedas (the \textbf{Chaturveda}), the revealed texts that ground the tradition.

\begin{longtable}{@{} L{0.26\textwidth}L{0.56\textwidth}@{}}
\caption{The four Vedas.}\\
\toprule
\textbf{Veda} & \textbf{Content} \\
\midrule
Rigveda & hymns of praise to the gods \\
Yajurveda & formulas for ritual sacrifice \\
Samaveda & melodies and chants \\
Atharvaveda & spells, charms, and everyday rites \\
\bottomrule
\end{longtable}

\subsection{The six darshanas}

The orthodox philosophy is set out in six schools (the \textbf{six darshanas}), the systems that accept the authority of the Vedas. They are usually paired.

\begin{longtable}{@{} L{0.26\textwidth}L{0.56\textwidth}@{}}
\caption{The six darshanas, the orthodox schools.}\\
\toprule
\textbf{School} & \textbf{Concern} \\
\midrule
Nyaya & logic and the means of valid knowledge \\
Vaisheshika & the categories and atoms of nature \\
Samkhya & the enumeration of consciousness and matter \\
Yoga & the discipline that stills the mind \\
Mimamsa & the interpretation of ritual and duty \\
Vedanta & the end of the Vedas, the knowledge of Brahman \\
\bottomrule
\end{longtable}

\subsection{The four aims of life}

A person's life has four legitimate aims (the \textbf{purusharthas}). The first three order worldly life and the fourth is the final goal.

\begin{longtable}{@{} L{0.20\textwidth}L{0.20\textwidth}L{0.42\textwidth}@{}}
\caption{The four aims of life.}\\
\toprule
\textbf{Aim} & \textbf{Native name} & \textbf{Meaning} \\
\midrule
right order & dharma & duty, ethics, the law that upholds life \\
prosperity & artha & wealth, livelihood, and worldly means \\
pleasure & kama & desire, love, and enjoyment \\
liberation & moksha & release from the cycle of rebirth \\
\bottomrule
\end{longtable}

\subsection{The four varnas}

Classical society is ordered into four broad classes (the \textbf{varnas}), each with its own duty.

\begin{longtable}{@{} L{0.26\textwidth}L{0.56\textwidth}@{}}
\caption{The four varnas.}\\
\toprule
\textbf{Varna} & \textbf{Role} \\
\midrule
...
\subsection{The four ashramas}

A life is also divided into four stages (the \textbf{ashramas}), the ordered seasons of a person's years.

\begin{longtable}{@{} L{0.26\textwidth}L{0.56\textwidth}@{}}
\caption{The four ashramas, the stages of life.}\\
\toprule
\textbf{Stage} & \textbf{Meaning} \\
\midrule
Brahmacharya & the student, learning and discipline \\
Grihastha & the householder, family and work \\
Vanaprastha & the forest-dweller, gradual withdrawal \\
Sannyasa & the renunciant, release from all ties \\
\bottomrule
\end{longtable}

\subsection{The ten avatars of Vishnu}

When right order declines, Vishnu the preserver descends in a bodily form (an \textbf{avatar}) to restore it. The standard set is the ten avatars (the \textbf{Dashavatara}).

\begin{longtable}{@{} L{0.06\textwidth}L{0.24\textwidth}L{0.50\textwidth}@{}}
\caption{The ten avatars of Vishnu.}\\
\toprule
\# & \textbf{Avatar} & \textbf{Form} \\
\midrule
1 & Matsya & the fish \\
...
7 & Rama & the prince of the Ramayana \\
8 & Krishna & the teacher of the Gita \\
9 & Buddha & the awakened one \\
10 & Kalki & the rider yet to come \\
\bottomrule
\end{longtable}

\subsection{The four states of consciousness}

The Mandukya Upanishad maps consciousness onto the syllable \textbf{Aum} (Om), splitting it into A, U, M, and the silence after. Each part is a state of the self.

\begin{longtable}{@{} L{0.18\textwidth}L{0.24\textwidth}L{0.40\textwidth}@{}}
\caption{The four states of consciousness and the parts of Aum.}\\
\toprule
\textbf{Part} & \textbf{State} & \textbf{Meaning} \\
\midrule
A & waking (jagrat) & outward awareness of the gross world \\
U & dream (svapna) & inward awareness of subtle images \\
M & deep sleep (sushupti) & undifferentiated rest, the causal state \\
the silence & the fourth (turiya) & pure consciousness behind all three \\
\bottomrule
\end{longtable}
