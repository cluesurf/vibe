...
section is the conceptual centrepiece of the diptych, a fork offered as a gift rather than a verdict. The diptych
...
The base is discrete and computable, and computability is the referee that lets both stories stand. As the section on computability
sets out, computability forbids the continuum and supertasks. It does not forbid an infinite past. So a
...
The fire and light images run across both stories. In Judaism, the Kabbalah names the ground the \emph{Ein Sof},
the infinite without end, whose boundless light contracts in \emph{tzimtzum} to leave room for a world, then
returns as a single ray whose scattered sparks are gathered back in the work of repair. In esoteric Christianity,
the Gnostic spark is that same fragment of light fallen into the world and longing for the \emph{Pleroma}, the
Fullness it came from. In Tibetan Buddhism the ground is the clear light, a luminous awareness from which all
appearances arise and into which they settle, neither made nor destroyed. A flame lit from a flame, undiminished,
says the new fire is real and begins yet nothing is created.

The water images run mostly to the eternal whole. In Hinduism the Vedanta image is a wave on the ocean, each wave
rising and falling yet being the ocean and never apart from it. A whirlpool in the river is the self as a pattern
in the flow rather than a substance, a standing eddy the water passes through.

The mind images carry the same double sense. In Hinduism the cosmos is the dream of Brahma, worlds arising and
dissolving as a dreamer dreams, which serves both stories, since the dream begins and ends while the dreamer is
eternal. Indra's Net, the Buddhist image of a net with a jewel at every knot each reflecting all the others, is
the part containing the whole, the mutually reflecting structure of the bulk. The Hermetic principle that the All
is Mind says the universe is one mind thinking, with every part a mirror of the whole.

The breath, seed, and word images carry the cyclic and unfolding sense. In Hinduism the breath of Brahma is the
universe breathing in and out across vast ages, beginningless and cyclic, each exhale a local beginning, and the
seed becoming the tree is the Upanishadic acorn and oak, the One unfolding into the many. The Word, the Logos of
esoteric Christianity and the Om of Hinduism, is the cosmos as an utterance, a first sounding from an eternal
speaker.

Indigenous and shamanic traditions reach for the same shapes, each with a prior fullness rather than a void. In
Scandinavian and Germanic myth the world tree joins the realms on one living trunk, the same world tree
the Druids honoured in the sacred oak. In African cosmology, as in the Egyptian Nun, the world rises from
primordial waters that were always there. In Native American and Mesoamerican traditions the world is woven or
spoken or born into being by a great spirit or creator, and there are endless hints at what the shape and structure
of the experiential realm was made of and how it worked in their experiences.

From number and geometry come the cleanest images. A number in the endless count has no smallest, the picture of
a beginningless past. A point on an endless line has no first point. A single definite point with nothing before
it, like the pole of a sphere, is the picture of a first moment with no before. And from weaving comes the thread
in an endless cloth, each life a thread, the fabric image of a self as a braid.

The beginningless story is served by the eternal-whole images, the wave in the ocean, the infinite light of the
Ein Sof, the clear light of the ground, the number with no smallest, Indra's net, the breath of Brahma. The
beginning story is served by the unfolding images, the ray after the contraction, the seed becoming the tree, the
Word sounding, the single point with no before. The shared and deepest point in all of them is that neither is
creation from nothing. Every ancient image has a prior fullness, the world a spark of the light, a wave of the
ocean, a note of the song. That is what the theory recovers. Existence is a fullness expressing itself, never a
void producing a thing.
