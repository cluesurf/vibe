...
ranges across every dimension. The chapters that follow give the selection argument itself. Here we describe the
...
No computation in the paper introduces a new term, field, bias, or rule beyond the stated base in order to make a
result come out. When a phenomenon does not emerge from the base, the negative is reported. The base is
fixed before the experiments run, and it stays fixed.
\end{principle}
