...
The selection argument has two halves. This chapter is the first. It shows that only a four-dimensional bulk
...
singles out $\{3,4,3,4\}$ within the four-dimensional family, is taken up in the next chapter.
...
class makes the real constraint visible. We use the taxonomy of the geometry chapter, where compact means every
