...
not overturn the selection. It sharpens it. The right reading of the previous sections is not that the
alternatives are forbidden, but that $\{3,4,3,4\}$ is the substrate of \emph{least emergence}. This section makes
