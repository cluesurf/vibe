...
export const PROBLEMS: Problem[] = [
  ...
  },
  {
    ...
    depends: ['R-FRC-0006'],
    source: 'E-FRC-0130, E-FRC-0132, E-FRC-0133, E-FRC-0146, E-FRC-0147, E-FRC-0152, E-FRC-0153',
  },
  {
    id: 'OP-13',
    ...
    known:
      'the committed knit does not conserve momentum (E-FLD-0020). The hop is 96 percent of the loss (E-FLD-0021). A rule in the family keeps particle momentum exactly iff its table has no hop and each couple keeps both line momenta, and 31 of 1,345 such members pass every structural gate, all dressing more (E-FLD-0022). The momentum weave keeps it at a dressing of 108,080 slots against 1,508 (E-FLD-0023)',
    unknown: 'momentum and low dressing together, and whether momentum can pass between lines (the smallest block that allows it is three lines of an A2 plane)',
    why: 'without momentum the knit has no conserved motion for a color charge to ride',
    skills: ['cellular automata', 'lattice gases'],
    scope: 'a computational search over blocks of three lines',
    starting: ['test/experiment/fluids/momentum-family.ts', 'test/experiment/fluids/momentum-weave-acceptance.ts'],
    depends: [],
  ...
  },
  {
    ...
    unknown: 'the doublet, a massive vector, Yukawa couplings, and a knit with coarse rotation symmetry and chirality surviving',
    why: 'the Higgs ledger rows stay algebra until one of these is measured',
    skills: ['lattice field theory', 'representation theory'],
    scope: 'open research',
    starting: ['test/experiment/gauge/vacuum-condensate-and-su2.ts', 'test/experiment/gauge/parity-of-the-rule.ts'],
    depends: [],
    source: 'E-FRC-0142, E-FRC-0143, E-RLT-0045, E-RLT-0046',
  },
]
