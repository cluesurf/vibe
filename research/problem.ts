...
export const PROBLEMS: Problem[] = [
  {
    ...
    known: 'the bare rule has no amplitudes: defects add exactly as sets (result 04)',
  ...
  },
  {
    ...
    why: 'result 03 is exact only for what it tested',
  ...
  },
  {
    ...
    known: 'on {5,4}, stretch 1.002 (result 06). On {3,4,3,4}, radius 3 at 750 and 3,000 cells (result 05)',
    unknown: 'the {3,4,3,4} routing at all, and either quantity at more than two sizes',
    why: 'planned paper 2 needs it, and result 06 is on the wrong tiling until it exists',
  ...
  },
  {
    ...
    why: 'result 08 claims less than "proof-checked" until it exists',
  ...
  },
  {
    ...
    question: 'Does the shared-ancestor mechanism imply C(r) ~ r^(-alpha), and what is alpha on the committed rule?',
    known: 'interior distance grows like the logarithm of boundary distance (result 10)',
    unknown: 'alpha, and whether any correlation is measured at all',
    why: 'turns candidate C-01 into a quantitative prediction, the first route to a row',
