...
export default experiment({
  ...
  run() {
    ...
    return verdict({
      status: ok ? 'pass' : 'fail',
      claim:
        'a choice reproduces exactly yet is jointly authored by self and urge, with agency rising with self-structure, and is irreducible',
      metrics: {
        selfDiversity: r.selfDiversity,
        meanSettlingBeats: r.meanSettlingBeats,
      },
    })
  },
})
