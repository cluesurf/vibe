...
export default experiment({
  ...
  run() {
    ...
    const interiorSparse =
      innermost < total * 0.1 && outermost > innermost * 3
    ...
    return verdict({
      ...
      metrics: {
        innermostCells: innermost,
        outermostCells: outermost,
        totalCells: total,
        interiorSparse: interiorSparse ? 1 : 0,
      },
      ...
      notes:
        'SS14 of experiments/17, the honest caveat. The flat array lives on the cusp horosphere, the tree structures (SS1) live in the bulk, the hash structures (SS2) on the boundary.',
    })
  },
})
