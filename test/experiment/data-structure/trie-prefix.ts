  ...
  run() {
    ...
    return verdict({
      ...
      metrics: {
        ...
        prefixConsistent: prefixConsistent ? 1 : 0,
      },
      // CONTROL: a flat trie stores one child pointer per edge, here the edge is the physical parent-child adjacency.
      control: {
        flatTriePointersStored: checked,
        bulkPointersStored: 0,
      },
      notes:
        'SS3 of experiments/17, extends DS2. The same address sorts (SS7) and gives the Merkle path (DS11).',
    })
  },
})
