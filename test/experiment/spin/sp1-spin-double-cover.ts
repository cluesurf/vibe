...
if (process.argv[1] !== undefined && import.meta.url === pathToFileURL(process.argv[1]).href) {
  ...
  const pass = r.isGroup && r.doubleCover && r.spinorMinusAt2pi && r.spinorPlusAt4pi && r.vectorPlusAt2pi
  console.log(`SOLVED SP1: 2T group ${r.isGroup}, double cover ${r.doubleCover}, spinor -1 at 2pi ${r.spinorMinusAt2pi}, +1 at 4pi ${r.spinorPlusAt4pi}, vector +1 at 2pi ${r.vectorPlusAt2pi} => GATE ${pass ? 'PASSED' : 'FAILED'}`)
}
