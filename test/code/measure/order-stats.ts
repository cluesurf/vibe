...
suite('measure/order-stats: orderStatistics', [
  check('a chain of 5: ordering fraction 1, height 5, ratio sqrt5, dimension ~ 1', () => {
  ...
  check('a star of 4 has ordering fraction 1/2 and dimension ~ 2', () => {
...
suite('measure/order-stats: causalSliceWidths', [
  ...
  check('a star of 4 has slice widths 1,3 (root, then the three leaves)', () => {
