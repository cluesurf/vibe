...
suite('substrate/tiling-pq: tree structure', [
  check('the pentagrid {5,4} tree has edges = nodes - 1 and is symmetric', () => {
    ...
    equal(degSum / 2, g.size - 1, 'a spanning tree has nodes - 1 edges')
  }),
  check('the first ring out of the root holds 5 cells (pentagrid)', () => {
