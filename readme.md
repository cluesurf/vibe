...
As of the latest run the catalog holds **679 experiments across 18
categories**: 80 at `L3` (emergent and novel), 425 at `L2` (known
physics reproduced), 160 at `L1` (known math confirmed), and 14 at `L0`
