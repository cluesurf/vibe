...
As of the latest run the catalog holds **754 experiments across 18
categories**: 81 at `L3` (emergent and novel), 482 at `L2` (known
physics reproduced), 177 at `L1` (known math confirmed), and 14 at `L0`
