...
As of the latest run the catalog holds **669 experiments across 18
categories**: 79 at `L3` (emergent and novel), 418 at `L2` (known
physics reproduced), 158 at `L1` (known math confirmed), and 14 at `L0`
