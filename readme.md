...
| ------- | ------------------------------------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| P1      | local rule with a bounded-below Hamiltonian | validated (partial)     | reversible rule is local (radius 1.67) and energy bounded below; but H = i log U is nonlocal for the XOR-parity rule (locality length ~0.8 N, grows with size), so a local rule does not give a local H |
