...
As of the latest run the catalog holds **627 experiments across 18
categories**: 84 at `L3` (emergent and novel), 401 at `L2` (known
physics reproduced), 128 at `L1` (known math confirmed), and 14 at `L0`
(circular), with 424 of them backing a specific claim in the papers. The
