...
| P2 | a dynamics that favors manifold-like order | open | the Benincasa-Dowker action does not concentrate on manifold-like orders (manifold-likeness falls as coupling rises) |
...
into a measured curve. **open** means genuinely unsolved (shared frontier
with the literature). **boundary** means outside what the simulator can
decide.
