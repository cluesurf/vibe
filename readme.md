...
every cell touches exactly 24 neighbors, one along each direction of
the D4 root system. That crystal is the $\lbrace3,4,3,4\rbrace$
honeycomb. There is no space underneath it. It IS space.
