...
**151 experiments.** Codes **[`E-FRC-0001`](../../../test/experiment/gauge/actual-rule-soliton.ts)** through **[`E-FRC-0153`](../../../test/experiment/gauge/knit-binding.ts)**. `E-FRC-0148` and `0149` are reserved for a run still in progress.
...
- **[`E-FRC-0141`](../../../test/experiment/gauge/generation-splitting.ts)** (L2) - what splits them: the committed turning weave splits all three on all 16 A2 planes, and a condensate on one copy under the triality weave gives 1 + 2.
