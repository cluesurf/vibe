...
- [validation.md](validation.md): the validation pass. Five predictions checked
  and confirmed: spin from topology (P4, zero modes = Betti sum), navigability to
  100 percent (P3), geometry sharp in proper time (P5), a local rule with a
  bounded-below Hamiltonian (P1), and charge coupling to the fermion (P8).
...
- **Validated:** spin from topology (P4), navigability to 100 percent (P3),
  geometry sharp in dimension and proper time (P5), a local rule with a
  bounded-below Hamiltonian (P1), charge coupling to the fermion (P8), the CHSH
  superdeterminism cost curve (P7).
- **Open, as expected:** the causal-set dynamics does not yet concentrate on
  manifold-like orders (P2, P6), and the chirality wall past P8, matching the
  literature.
