...
| [quantum](quantum/readme.md) | 72 | the quantum as emergent from a deterministic reversible base: Born rule, entanglement, the shared-past mechanism, measurement as settling |
