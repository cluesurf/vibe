...
| P2 | manifold-favoring dynamics | first-order transition at N=128: smeared action makes manifold spacetime a stable phase (correct sampler, see p2-uniform.md) | solved at scale |
