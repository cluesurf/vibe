...
- **Gravity is a coarse-grained stress response** (the geometry bending to match the
  ...
  volume) from the conserved substrate (E-GRV-0047). Chronoflux: curvature forced to match
...
| --- | --- | --- | --- |
| conserved tone, integer-exact | the conserved current div J = 0 | E-FND-0008 | firm |
| the coarse (block-averaged) tone-current is conserved | zero-divergence continuity | E-GRV-0039 | firm |
| the wake, a positive outflow at the edge | the expansion scalar | E-CSM-0043 | firm |
| how much a coarse region can recover | the recoverability functional R | E-GRV-0040 | firm |
| the coarse tone-current in the smooth limit | the continuum current | E-GRV-0046 | structural |
| the coarse tone-stress balances | gravity as stress consistency | E-GRV-0047 | structural |
